...
import { getColor, getStingOnAPILanguage } from '../utils/utility'
...
const ToggleButtonWithLabel = ({ endorseMent, handleChange }) => {
    return (
        <div className="box-switch" style={{ boxShadow: `0 2px 5px 0 ${getColor()}, 0 2px 10px 0 ${getColor()}` }}>
            <label className='endorsedesc'>{getStingOnAPILanguage(endorseMent, 'endorsementDescription')} ${endorseMent.endorsementFee} </label>

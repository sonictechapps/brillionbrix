...
const BuyerNetSheetQuoteSummary = () => {
    ...
    const onPDFGenerate = () => {
        ...
        doc.setFontSize(14)
        doc.text(`${getStingOnLanguage('BUYER_ESTIMATE')} ${getStingOnLanguage('TITLE_QUOTE_PROVIDED')} ${titleCompanyInfo.companyName}`, 50, finalY + 15)
        doc.setFontSize(10)
            ...
            <div className="container container-fluid">
                ...
                <div className="row content">
                    <div className="col-sm-12 mt-3">
                        {titleCompanyInfo
                            && <div><h2 className="labelstyle-quote">{getStingOnLanguage('BUYER_ESTIMATE')} {getStingOnLanguage('TITLE_QUOTE_PROVIDED')} {titleCompanyInfo.companyName}. </h2></div>}
                        {quoteCreatedOn &&
